...
class Ui_adde(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_2.addWidget(self.toolButton, 3, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.toolButton_2, 3, 1, 1, 1)
        
        self.COM=QtGui.QComboBox(Form)
        self.COM.setObjectName(_fromUtf8("COM"))
        self.COM.addItems(self.modile)
        self.gridLayout_2.addWidget(self.COM, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "grop", None))
    ...
    def INSERTelev(self):
        if self.lineEdit.text()!= '' and self.lineEdit_3.text()!='' and self.lineEdit_2.text() != '' and self.lineEdit_4.text() != '':
            ...
            self.C=str(self.COM.currentText())
            print(self.C)
            cursor.execute('''SELECT ID FROM MATIERE WHERE NAMEM=?''',(self.C,))
            I=cursor.fetchone()
            cursor.execute('''INSERT INTO PROF(name,date,ide) VALUES(?,?,?)''',(self.b,self.lineEdit_3.text(),I[0]))
    ...
    def silckte(self,item): 
        cursor.execute('''DELETE  FROM PROF WHERE name=?''',(self.B[0],))
